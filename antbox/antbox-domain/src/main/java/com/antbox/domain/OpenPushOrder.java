...
/*    */ 
/*    */ @Entity
/*    */ @Table(name="t_open_push_order")
/*    */ @DynamicInsert
/*    */ @DynamicUpdate
/*    */ @Where(clause="deleted = 0")
/*    */ public class OpenPushOrder
/*    */   extends IDEntity
/*    */ {
...
/*    */   {
/* 68 */     return "OpenPushOrder{mallId=" + this.mallId + ", merchantId=" + this.merchantId + ", pushNum=" + this.pushNum + ", orderNum=" + this.orderNum + '}';
/*    */   }
/*    */ }


/* Location:              D:\antbox-domain-1.0.0.jar!\com\antbox\domain\OpenPushOrder.class

...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="campaign" action="${ctx}/campaign/campaign/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					<td class="width-15 active"><label class="pull-right">减免细节，以json格式存储。 满减：10-2,20-5,30-7 随机减：1-10 首单优惠：5：</label></td>
					<td class="width-35">
						<form:input path="discount" htmlEscape="false"    class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">活动参与售货机Id，逗号分隔，0表示所有售货机：</label></td>
					<td class="width-35">
						<form:input path="vendingMachine.id" htmlEscape="false"    class="form-control "/>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">活动编号：</label></td>
					<td class="width-35">
						<form:input path="campaignNo" htmlEscape="false"    class="form-control "/>
					</td>
				...
				<tr>
					<td class="width-15 active"><label class="pull-right">操作员id (User.id)：</label></td>
					<td class="width-35">

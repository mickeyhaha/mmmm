		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					...
					<td class="width-15 active"><label class="pull-right">是否开通alipay：</label></td>
					<td class="width-35">
						<form:input path="alipay" htmlEscape="false"    class="form-control "/>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">是否开通微信支付：</label></td>
					<td class="width-35">
						<form:input path="wechatPay" htmlEscape="false"    class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">上次交易状态：完成，未完成：</label></td>
					<td class="width-35">
						<form:input path="lastOrderState" htmlEscape="false"    class="form-control "/>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">注册时间：</label></td>
					<td class="width-35">
						<form:input path="regTime" htmlEscape="false"    class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">客户状态：启用，停用，黑名单：</label></td>
					<td class="width-35">
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="vmGroup.id" htmlEscape="false"    class="form-control "/>
					</td>

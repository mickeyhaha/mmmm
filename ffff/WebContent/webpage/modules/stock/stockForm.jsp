...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="stock" action="${ctx}/stock/stock/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<form:input path="goodsNo" htmlEscape="false"    class="form-control "/>
					</td>
				...
				<tr>
					<td class="width-15 active"><label class="pull-right">物品类型：</label></td>
					<td class="width-35">
						<form:input path="goodsType" htmlEscape="false"    class="form-control "/>
					</td>
				...
				<tr>
					<td class="width-15 active"><label class="pull-right">产品ID：</label></td>
					<td class="width-35">
						<form:input path="product.id" htmlEscape="false"    class="form-control "/>
					</td>

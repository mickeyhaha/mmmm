...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="vmGroup" action="${ctx}/vmgroup/vmGroup/" method="post" class="form-inline">
	...
	<div class="col-sm-12">
		<div class="pull-left">
			...
			<shiro:hasPermission name="vmgroup:vmGroup:import">
				<table:importExcel url="${ctx}/vmgroup/vmGroup/import"></table:importExcel><!-- 导入按钮 -->
			</shiro:hasPermission>
			<shiro:hasPermission name="vmgroup:vmGroup:export">
	       		<table:exportExcel url="${ctx}/vmgroup/vmGroup/export"></table:exportExcel><!-- 导出按钮 -->
	       	</shiro:hasPermission>
